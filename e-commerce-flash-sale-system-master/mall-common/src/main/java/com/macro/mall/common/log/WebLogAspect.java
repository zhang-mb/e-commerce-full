...
//        LOGGER.info("{}", JSONUtil.parse(webLog));
    ...
    private Object getParameter(Method method, Object[] args) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            //将RequestBody注解修饰的参数作为请求参�?            RequestBody requestBody = parameters[i].getAnnotation(RequestBody.class);
            if (requestBody != null) {
                argList.add(args[i]);
            }
            //将RequestParam注解修饰的参数作为请求参�?            RequestParam requestParam = parameters[i].getAnnotation(RequestParam.class);
